...
const search_country_element = document.querySelector(".search");
const country_list_element = document.querySelector(".countrylist");
const chang_country_btn = document.querySelector(".changecountry");
